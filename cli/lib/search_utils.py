...
# chunking
DEFAULT_CHUNK_SIZE = 200 # only for cli chinking
...
CHUNK_EMBEDDINGS_PATH = os.path.join(PROJECT_ROOT, CACHE_DIR, "chunk_embeddings.npy")
CHUNK_METADATA_PATH = os.path.join(PROJECT_ROOT, CACHE_DIR, "chunk_metadata.json")
